...
#' penalty.type <- 3
#' penalty.value <- 10000
#' fitness_results <- ga.fitness(search.space,fit.results, string, crse, cshrink, lbcl, lbvc, lbvp, lbq, lbvp2, lbq2, cadd, cprop, ccorr, penalty.type, penalty.value)
#' print(fitness_results)
#' }
#' @export
ga.fitness <- function(search.space,
                       fit.results,
                       string,
                       crse,
                       cshrink,
