...
#' and evaluates the model's performance based on `aco.fitness`.
#'
...
#' fitness <- aco.mod.run(modi=1, r = 1, dat = dat, search.space = 1, string = string,
